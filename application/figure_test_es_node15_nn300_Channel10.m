...
load('final_test_es_node15_nn300_Channel10_T920_d40_lam03.mat')
...
% legend('DIR', 'CIR', 'SLS', 'DRD', 'PLS','Location','best')
    yticks(0:0.1:1);
set(gca, 'FontSize', 20); 
saveas(1,'test_es_cos_node15_nn300_channel_10.png')
...
yticks(0:0.2:4);
set(gca, 'FontSize', 20);
saveas(2,'test_es_L2_node15_nn300_channel_10.png')