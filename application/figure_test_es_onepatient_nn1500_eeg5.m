...
load('final_test_es_patient1_nn1500_eeg5_T1200_d200_lam03.mat')
...
% legend('DIR', 'CIR', 'SLS', 'DRD', 'PLS','Location','best')
    yticks(0:0.1:1);
set(gca, 'FontSize', 20); 
saveas(1,'test_es_cos_onepatient_nn1500_eeg5.png')
...
yticks(0:0.2:4);
set(gca, 'FontSize', 20);
saveas(2,'test_es_L2_onepatient_nn1500_eeg5.png')