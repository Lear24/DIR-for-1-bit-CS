...
load('final_test_es_node15_nn300_Channel1_T200_d40_lam03.mat')
...
saveas(1,'test_es_cos_node15_nn300_channel_1.png')
...
yticks(0:0.2:4);
set(gca, 'FontSize', 20);
saveas(2,'test_es_L2_node15_nn300_channel_1.png')