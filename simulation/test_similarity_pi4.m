...
pl_mu = 4;pl_sig=1.8;sample_mean=40; sample_range_ratio = 0.805;
...
for rep = 73:rep_num
    ...
    for i = 1:lam_num
        ...
        save('test_similarity_lambda_vary_pi4_rep100.mat')
    end
end
%%
clear
clc
%%
load('test_similarity_lambda_vary_pi4_rep100.mat')
...
%%
% load('test_similarity_lambda_vary_pi4_compelete_rep100.mat')
figure(1)
hold on
grid on
box on
...
title('The Heterogeneity of Parameter (\theta = \pi/4)', 'FontSize', 14);
...
%%
% saveas(1,'test_cos_similarity_lam_pi4_rep100.png')
% save('test_similarity_lambda_vary_pi4_compelete_rep100.mat')
...
%% 
saveas(2,'test_boxchart_similarity_lam_pi4_rep100.png')
