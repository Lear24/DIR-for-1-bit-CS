...
for rep = 1:rep_num
    for i = 1:m_num
        ...
        save('test_total_sample_vary_n60_pi4.mat')
    end
end

%%
load('test_total_sample_vary_n60_pi4.mat')
rep_num = 100;
...
% result_mat_cos = log(result_mat_cos);
...
% yticks(0:0.1:1);
set(gca, 'FontSize', 20); 
saveas(1,'test_cos_total_sample_vary_n60_pi4.png')
% saveas(1,'test_cos_total_sample_vary_n60_pi4.pdf')
...
yticks(-1.5:0.2:0.5);
set(gca, 'FontSize', 20);
saveas(2,'test_L2_total_sample_vary_n60_pi4.png')
% saveas(2,'test_L2_total_sample_vary_n60_pi4.pdf')