...
for rep = 1:rep_num
    ...
    for i = 1:sigma2_num
        ...
        save('test_noise_variance_04_rep100_pi4.mat')
    end
end

%%
load('test_noise_variance_04_rep100_pi4.mat')
rep_num = 100;
...
saveas(1,'test_cos_noise_variance_04_rep100_pi4.png')
...
yticks(0:0.2:4);
set(gca, 'FontSize', 20);
saveas(2,'test_L2_noise_variance_04_rep100_pi4.png')
