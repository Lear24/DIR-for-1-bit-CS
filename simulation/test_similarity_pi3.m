...
%         disp(mean(abs([cos_value1,cos_value2,cos_value4])));
        ...
        save('test_similarity_lambda_vary_pi3_rep100.mat')
    end
end

%%
load('test_similarity_lambda_vary_pi3_rep100.mat')
...
%%
load('test_similarity_lambda_vary_pi3_compelete_rep100.mat')
figure(1)
hold on
grid on
box on
...
title('The Heterogeneity of Parameter (\theta = \pi/3)', 'FontSize', 14);
...
%% 
saveas(2,'test_boxchart_similarity_lam_pi3_rep100.png')