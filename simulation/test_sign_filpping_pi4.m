...
%         toc
        ...
        save('test_sign_filpping_0075_rep100_pi4.mat')
    end
end

%%
load('test_sign_filpping_0075_rep100_pi4.mat')
rep_num = 100;
...
saveas(1,'test_cos_sign_filpping_0075_rep100_pi4.png')
...
yticks(0:0.2:4);
set(gca, 'FontSize', 20);
saveas(2,'test_L2_sign_filpping_0075_rep100_pi4.png')