...
for rep = 1:rep_num
    for i = 1:n_num
        ...
        save('test_local_sample_vary_N2400_pi3.mat')
    end
end
%%
load('test_local_sample_vary_N2400_pi3.mat')
rep_num = 100;
...
yticks(0:0.1:1);
set(gca, 'FontSize', 20); 
saveas(1,'test_cos_local_sample_vary_N2400_pi3.png')
...
saveas(2,'test_L2_local_sample_vary_N2400_pi3.png')
