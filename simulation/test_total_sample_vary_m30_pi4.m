...
d=20; % beta 维数
n_vary = [50;60;70;80;90;100;110;120]; % 7
n_num = 8;
...
for rep = 1:rep_num
    for i = 1:n_num
        ...
        save('test_total_sample_vary_m30_pi4.mat')
    end
end

%%
load('test_total_sample_vary_m30_pi4.mat')
rep_num = 100;
...
yticks(0:0.1:1);
set(gca, 'FontSize', 20); 
saveas(1,'test_cos_total_sample_vary_m30_pi4.png')
...
yticks(0:0.2:4);
set(gca, 'FontSize', 20);
saveas(2,'test_L2_total_sample_vary_m30_pi4.png')
