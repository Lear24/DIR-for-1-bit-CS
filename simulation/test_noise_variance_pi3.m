...
%%
load('test_noise_variance_04_rep100.mat')
...
%%
load('test_noise_variance_04_rep100_pi3.mat')
result = result1;
rep_num = 100;
...
yticks(0:0.1:1);
set(gca, 'FontSize', 20); 
saveas(1,'test_cos_noise_variance_04_rep100_pi3.png')
% save('test_noise_variance_04_rep100_pi3.mat')
...
yticks(0:0.2:4);
set(gca, 'FontSize', 20);
saveas(2,'test_L2_noise_variance_04_rep100_pi3.png')
