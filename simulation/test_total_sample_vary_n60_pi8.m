...
for rep = 1:rep_num
    for i = 1:m_num
        ...
        save('test_total_sample_vary_n60_pi8.mat')
    end
end

%%
load('test_total_sample_vary_n60_pi8.mat')
rep_num = 100;
...
legend('DIR','CIR','SLS','DRD','PLS',...
    ...
    'Position',[0.62,0.65,0.1,0.1])
saveas(1,'test_cos_total_sample_vary_n60_pi8.png')
% saveas(1,'test_cos_total_sample_vary_n60.pdf')
...
legend('DIR','CIR','SLS','DRD','PLS',...
    'Location','best','Orientation','horizontal','FontSize', 12,'NumColumns', 3,...
    'Position',[0.62,0.4,0.1,0.1])
saveas(2,'test_L2_total_sample_vary_n60_pi8.png')
% saveas(2,'test_L2_total_sample_vary_n60_pi8.pdf')