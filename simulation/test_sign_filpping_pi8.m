...
%         toc
        ...
        save('test_sign_filpping_0075_rep100_pi8.mat')
    end
end

%%
load('test_sign_filpping_0075_rep100_pi8.mat')
rep_num = 100;
...
legend('DIR','CIR','SLS','DRD','PLS',...
    ...
    'Position',[0.62,0.35,0.1,0.1])
saveas(1,'test_cos_sign_filpping_0075_rep100_pi8.png')
...
saveas(2,'test_L2_sign_filpping_0075_rep100_pi8.png')